...
class Level {
    constructor(widthORobject, height, tilesize = 16, tiles = [], entities = [], src = "./maps/bg-1-1-correctcrop.png", music = "./sounds/smb_overworld.wav") {
        if(typeof(widthORobject) == "object") {
            ...
            this.music    = widthORobject.music;
        } else {
